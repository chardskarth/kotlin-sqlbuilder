package me.chardskarth.sqlbuilder.dsl

import me.chardskarth.sqlbuilder.QueryBlock

infix fun String.eq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.eq(this, value)
}
...
infix fun String.neq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.neq(this, value)
}
...
infix fun String.greater(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.greater(this, value)
}

infix fun String.greaterEq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.greaterEq(this, value)
}

infix fun String.less(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.less(this, value)
}

infix fun String.lessEq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.lessEq(this, value)
}
...
infix fun QueryBlock.eq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.eq(this.toString(), value)
}
...
infix fun QueryBlock.neq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.neq(this.toString(), value)
}
...
infix fun QueryBlock.greater(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.greater(this.toString(), value)
}

infix fun QueryBlock.greaterEq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.greaterEq(this.toString(), value)
}

infix fun QueryBlock.less(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.less(this.toString(), value)
}

infix fun QueryBlock.lessEq(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.lessEq(this.toString(), value)
}
...
infix fun String.like(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.like(this, value)
}

infix fun String.notLike(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.notLike(this, value)
}

infix fun String.regexp(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.regexp(this, value)
}

infix fun String.notRegexp(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.notRegexp(this, value)
}

infix fun String.match(value: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.match(this, value)
}
...
infix fun String.isNotNull(value: Boolean): QueryBlock {
    if (value) {
        return me.chardskarth.sqlbuilder.sqloperators.isNotNull(this)
    }
    return QueryBlock("", "")
}
...
infix fun String.isNull(value: Boolean): QueryBlock {
    if (value) {
        return me.chardskarth.sqlbuilder.sqloperators.isNull(this)
    }
    return QueryBlock("", "")
}

infix fun String.inList(values: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.inList(this, values)
}
...
infix fun String.inList(valueSize: Int): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.inList(this, valueSize)
}

infix fun String.notInList(values: String): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.notInList(this, values)
}
...
infix fun String.notInList(valueSize: Int): QueryBlock {
    return me.chardskarth.sqlbuilder.sqloperators.notInList(this, valueSize)
}
...
infix fun String.between(values: Pair<*, *>): QueryBlock {
    ...
    if (value1 is String) {
        ...
        return me.chardskarth.sqlbuilder.sqloperators.between(this, value1, value2)
        ...
        return me.chardskarth.sqlbuilder.sqloperators.between(this, value1.toString(), value2.toString())
    }
    return QueryBlock("", "")
}
